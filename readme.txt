...
The file I need help on is the invoice.html, on click of the add button I need it to add an extra row duplicated from the parent row.

NOT: DOES NOT REQUIRE MIGRATIONS. 